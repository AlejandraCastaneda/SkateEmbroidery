...
#%%
    ...
    data = pd.read_csv('/Users/alejc/OneDrive/Desktop/CS181MCS/FinalProject/Routes/UCDavis.csv')
...
def minMax():
    ...
    data = pd.read_csv('/Users/alejc/OneDrive/Desktop/CS181MCS/FinalProject/Routes/clean_UCD.csv')
...
#%%
# Normalize 
update = pd.read_csv('/Users/alejc/OneDrive/Desktop/CS181MCS/FinalProject/Routes/clean_UCD.csv')
...
update['Scaled_X'] = (data['X'] - x_min) * x_scaling_factor + x_target_min
update['Scaled_Y'] = (data['Y'] - y_min) * y_scaling_factor + y_target_min
